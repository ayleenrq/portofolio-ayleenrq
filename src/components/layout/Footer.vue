    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="space-y-4">
          ...
          <p class="text-gray-600">Creating beautiful and functional web experiences with modern technologies.</p>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li v-for="link in links" :key="link.href">
              <a :href="link.href" class="text-gray-600 hover:text-blue-600 transition-colors">
                {{ link.name }}
              </a>
            </li>
          </ul>
      ...
      <div class="mt-12 pt-8 border-t border-gray-200 text-center">
        <p class="text-sm text-gray-500">
          &copy; {{ currentYear }} Ayleen RQ. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
