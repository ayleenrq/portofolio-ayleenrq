        ...
        <div class="px-6">
          <div class="pb-10 border-l border-gray-200">
            <div class="relative flex flex-col justify-start pl-12">
              ...
              >
                <img
                  src="../../../assets/images/education/State Polytechnic of Malang.png"
                  alt="Education"
                  class="w-8 h-8"
                />
              </div>
          ...
          <div class="pb-10 border-l border-gray-200">
            <div class="relative flex flex-col justify-start pl-12">
              ...
              >
                <img
                  src="../../../assets/images/education/Vocational High School Telkom Sandhy Putra Malang.png"
                  alt="Education"
                  class="w-7 h-7"
                />
              </div>
              <div class="z-50 flex flex-col justify-start">
                <h3 class="text-lg font-semibold">Computer and Network Engineering</h3>
                <p class="font-medium text-gray-800 my-1">
                  Vocational High School Telkom Sandhy Putra Malang
                </p>
